...
/** @constructor */
function $c_Ltetris_Tetris$() {
  $c_O.call(this)
}
$c_Ltetris_Tetris$.prototype = new $h_O();
$c_Ltetris_Tetris$.prototype.constructor = $c_Ltetris_Tetris$;
/** @constructor */
function $h_Ltetris_Tetris$() {
  /*<skip>*/
}
$h_Ltetris_Tetris$.prototype = $c_Ltetris_Tetris$.prototype;
$c_Ltetris_Tetris$.prototype.init___ = (function() {
  return this
});
$c_Ltetris_Tetris$.prototype.main__Lorg_scalajs_dom_raw_HTMLCanvasElement__V = (function(canvas) {
  var ctx = canvas.getContext("2d");
  canvas.focus();
  var keys = new $c_scm_HashSet().init___();
  var this$4 = $m_s_Console$();
  var this$5 = $as_Ljava_io_PrintStream(this$4.outVar$2.v$1);
  this$5.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Started Tetris\n");
  ctx.fillStyle = "rgb(255, 255, 255)";
  ctx.fillRect(0.0, 0.0, 700.0, 500.0);
  var elem = $m_Ltetris_GameState$().initGameState__I__I__Ltetris_GameState(10, 20);
  var gameState = new $c_sr_ObjectRef().init___O(elem);
  var frame = new $c_sr_IntRef().init___I(0);
  canvas.onkeydown = (function(keys$1) {
    return (function(e$2) {
      var elem$1 = $uI(e$2.keyCode);
      return $s_scm_FlatHashTable$class__addElem__scm_FlatHashTable__O__Z(keys$1, elem$1)
    })
  })(keys);
  canvas.onkeyup = (function(keys$1$1) {
    return (function(e$2$1) {
      var elem$2 = $uI(e$2$1.keyCode);
      return $s_scm_FlatHashTable$class__removeElem__scm_FlatHashTable__O__Z(keys$1$1, elem$2)
    })
  })(keys);
  $m_sjs_js_timers_package$().setInterval__D__F0__sjs_js_timers_SetIntervalHandle(40.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(ctx$1, keys$1$2, gameState$1, frame$1) {
    return (function() {
      $m_Ltetris_Tetris$().tetris$Tetris$$run$1__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__scm_Set__sr_ObjectRef__sr_IntRef__V(ctx$1, keys$1$2, gameState$1, frame$1)
    })
  })(ctx, keys, gameState, frame)))
});
$c_Ltetris_Tetris$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLCanvasElement__O = (function(canvas) {
  this.main__Lorg_scalajs_dom_raw_HTMLCanvasElement__V(canvas)
});
$c_Ltetris_Tetris$.prototype.drawBlock__I__I__Ltetris_types_package$Color__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__V = (function(x, y, col, ctx, rectWidth, rectHeight) {
  var r = col.r$1;
  var g = col.g$1;
  var b = col.b$1;
  ...
  ctx.beginPath();
  ctx.moveTo(x, y);
  ctx.lineTo(((x + rectWidth) | 0), y);
  ctx.lineTo(((x + rectWidth) | 0), ((y + rectHeight) | 0));
  ctx.lineTo(x, ((y + rectHeight) | 0));
  ctx.lineTo(x, y);
  ctx.stroke()
});
$c_Ltetris_Tetris$.prototype.render__Ltetris_GameState__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__V = (function(gameState, ctx, width, height) {
  var rectHeight = ((height / gameState.grid$1.length__I()) | 0);
  ctx.clearRect(0.0, 0.0, width, height);
  var end = gameState.grid$1.length__I();
  var isEmpty$4 = (end <= 0);
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      ...
      if ((!isEmpty$4$1)) {
        ...
        while (true) {
          var v1 = i$1;
          var x = $imul(rectHeight, v1);
          var y = $imul(rectHeight, j);
          $m_Ltetris_Tetris$().drawBlock__I__I__Ltetris_types_package$Color__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__V(x, y, $as_Ltetris_types_package$Color($as_sci_Vector(gameState.grid$1.apply__I__O(j)).apply__I__O(v1)), ctx, rectHeight, rectHeight);
  ...
  while (true) {
    var v1$1 = i$2;
    var x$1 = $imul($as_Ltetris_types_package$Point(gameState.activePiece$1.blocks__sci_Vector().apply__I__O(v1$1)).x$1, rectHeight);
    var y$1 = $imul($as_Ltetris_types_package$Point(gameState.activePiece$1.blocks__sci_Vector().apply__I__O(v1$1)).y$1, rectHeight);
    $m_Ltetris_Tetris$().drawBlock__I__I__Ltetris_types_package$Color__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__V(x$1, y$1, gameState.activePiece$1.color$1, ctx, rectHeight, rectHeight);
    if ((i$2 === 3)) {
      break
    };
    i$2 = ((1 + i$2) | 0)
  ...
  ctx.fillText(("ROWS: " + gameState.lines$1), ((width / 2) | 0), ((height / 6) | 0));
  ctx.fillText(("LEVEL: " + ((gameState.lines$1 / 10) | 0)), ((width / 2) | 0), ((height / 4) | 0));
  ctx.fillText("NEXT PIECE: ", ((width / 2) | 0), (($imul(3, height) / 5) | 0));
  var i$3 = 0;
  while (true) {
    var v1$2 = i$3;
    var x$2 = (((($imul(45, width) / 100) | 0) + $imul($as_Ltetris_types_package$Point(gameState.nextPiece$1.blocks__sci_Vector().apply__I__O(v1$2)).x$1, rectHeight)) | 0);
    var y$2 = (((($imul(7, height) / 10) | 0) + $imul($as_Ltetris_types_package$Point(gameState.nextPiece$1.blocks__sci_Vector().apply__I__O(v1$2)).y$1, rectHeight)) | 0);
    $m_Ltetris_Tetris$().drawBlock__I__I__Ltetris_types_package$Color__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__V(x$2, y$2, gameState.nextPiece$1.color$1, ctx, rectHeight, rectHeight);
    if ((i$3 === 3)) {
      break
    };
    i$3 = ((1 + i$3) | 0)
  ...
  if (gameState.gameEnded$1) {
    ...
    ctx.fillText("GAME OVER", ((width / 2) | 0), (($imul(45, height) / 100) | 0))
  }
});
$c_Ltetris_Tetris$.prototype.tetris$Tetris$$run$1__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__scm_Set__sr_ObjectRef__sr_IntRef__V = (function(ctx$1, keys$1, gameState$1, frame$1) {
  if ($s_scm_FlatHashTable$class__containsElem__scm_FlatHashTable__O__Z(keys$1, 38)) {
    gameState$1.elem$1 = $as_Ltetris_GameState(gameState$1.elem$1).rotate__Ltetris_GameState();
    $s_scm_FlatHashTable$class__removeElem__scm_FlatHashTable__O__Z(keys$1, 38)
  } else if ($s_scm_FlatHashTable$class__containsElem__scm_FlatHashTable__O__Z(keys$1, 37)) {
    gameState$1.elem$1 = $as_Ltetris_GameState(gameState$1.elem$1).moveLeft__Ltetris_GameState();
    $s_scm_FlatHashTable$class__removeElem__scm_FlatHashTable__O__Z(keys$1, 37)
  } else if ($s_scm_FlatHashTable$class__containsElem__scm_FlatHashTable__O__Z(keys$1, 39)) {
    gameState$1.elem$1 = $as_Ltetris_GameState(gameState$1.elem$1).moveRight__Ltetris_GameState();
    $s_scm_FlatHashTable$class__removeElem__scm_FlatHashTable__O__Z(keys$1, 39)
  } else if ($s_scm_FlatHashTable$class__containsElem__scm_FlatHashTable__O__Z(keys$1, 40)) {
    gameState$1.elem$1 = $as_Ltetris_GameState(gameState$1.elem$1).moveDown__Ltetris_GameState();
    $s_scm_FlatHashTable$class__removeElem__scm_FlatHashTable__O__Z(keys$1, 40)
  };
  var level = (($as_Ltetris_GameState(gameState$1.elem$1).lines$1 / 10) | 0);
  var this$3 = $m_s_package$().Vector$1;
  var array = [1, $doubleToInt((20 - (12.732395447351628 * $uD($g.Math.atan(level)))))];
  if (($uI(array.length) === 0)) {
    var this$4 = this$3.NIL$6
  } else {
    ...
    var this$4 = b.result__sci_Vector()
  };
  var cmp = $m_s_math_Ordering$Int$();
  var gameSpeed = $uI($s_sc_TraversableOnce$class__max__sc_TraversableOnce__s_math_Ordering__O(this$4, cmp));
  if ((((frame$1.elem$1 % gameSpeed) | 0) === 0)) {
    gameState$1.elem$1 = $as_Ltetris_GameState(gameState$1.elem$1).moveDown__Ltetris_GameState()
  };
  this.render__Ltetris_GameState__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__V($as_Ltetris_GameState(gameState$1.elem$1), ctx$1, 700, 500);
  frame$1.elem$1 = ((1 + frame$1.elem$1) | 0)
});
$c_Ltetris_Tetris$.prototype.main = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLCanvasElement__O(prep0)
});
var $d_Ltetris_Tetris$ = new $TypeData().initClass({
  Ltetris_Tetris$: 0
}, false, "tetris.Tetris$", {
  Ltetris_Tetris$: 1,
  O: 1
});
$c_Ltetris_Tetris$.prototype.$classData = $d_Ltetris_Tetris$;
var $n_Ltetris_Tetris$ = (void 0);
function $m_Ltetris_Tetris$() {
  if ((!$n_Ltetris_Tetris$)) {
    $n_Ltetris_Tetris$ = new $c_Ltetris_Tetris$().init___()
  };
  return $n_Ltetris_Tetris$
}
$e.tetris = ($e.tetris || {});
$e.tetris.Tetris = $m_Ltetris_Tetris$;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
/** @constructor */
function $c_Ltetris_GameState$() {
  $c_O.call(this)
}
$c_Ltetris_GameState$.prototype = new $h_O();
$c_Ltetris_GameState$.prototype.constructor = $c_Ltetris_GameState$;
/** @constructor */
function $h_Ltetris_GameState$() {
  /*<skip>*/
}
$h_Ltetris_GameState$.prototype = $c_Ltetris_GameState$.prototype;
$c_Ltetris_GameState$.prototype.init___ = (function() {
  return this
});
$c_Ltetris_GameState$.prototype.initGameState__I__I__Ltetris_GameState = (function(width, height) {
  var activePiece = $m_Ltetris_Piece$().randomPiece__Ltetris_types_package$Point__Ltetris_Piece(new $c_Ltetris_types_package$Point().init___I__I((((-1) + ((width / 2) | 0)) | 0), 0));
  $m_s_package$();
  var b = new $c_sci_VectorBuilder().init___();
  var i = 0;
  while ((i < height)) {
    ...
    var i$1 = 0;
    while ((i$1 < width)) {
      var elem = new $c_Ltetris_types_package$Color().init___I__I__I(0, 0, 0);
  ...
  var grid = b.result__sci_Vector();
  var nextPiece = $m_Ltetris_Piece$().randomPiece__Ltetris_types_package$Point__Ltetris_Piece(new $c_Ltetris_types_package$Point().init___I__I((((-1) + ((width / 2) | 0)) | 0), 0));
  return new $c_Ltetris_GameState().init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece(grid, activePiece, 0, false, nextPiece)
});
var $d_Ltetris_GameState$ = new $TypeData().initClass({
  Ltetris_GameState$: 0
}, false, "tetris.GameState$", {
  Ltetris_GameState$: 1,
  O: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Ltetris_GameState$.prototype.$classData = $d_Ltetris_GameState$;
var $n_Ltetris_GameState$ = (void 0);
function $m_Ltetris_GameState$() {
  if ((!$n_Ltetris_GameState$)) {
    $n_Ltetris_GameState$ = new $c_Ltetris_GameState$().init___()
  };
  return $n_Ltetris_GameState$
}
/** @constructor */
function $c_Ltetris_Piece$() {
  $c_O.call(this)
}
$c_Ltetris_Piece$.prototype = new $h_O();
$c_Ltetris_Piece$.prototype.constructor = $c_Ltetris_Piece$;
/** @constructor */
function $h_Ltetris_Piece$() {
  /*<skip>*/
}
$h_Ltetris_Piece$.prototype = $c_Ltetris_Piece$.prototype;
$c_Ltetris_Piece$.prototype.init___ = (function() {
  return this
});
$c_Ltetris_Piece$.prototype.squarePiece__Ltetris_types_package$Point__Ltetris_Piece = (function(center) {
  var this$1 = $m_s_package$().Vector$1;
  var array = [new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 0), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(1, 1)];
  if (($uI(array.length) === 0)) {
    var stdBlocks = this$1.NIL$6
  } else {
    var b = new $c_sci_VectorBuilder().init___();
    var i = 0;
    var len = $uI(array.length);
    ...
    var stdBlocks = b.result__sci_Vector()
  };
  var this$2 = $m_s_package$().Vector$1;
  var array$1 = [stdBlocks, stdBlocks, stdBlocks, stdBlocks];
  if (($uI(array$1.length) === 0)) {
    var jsx$1 = this$2.NIL$6
  } else {
    var b$1 = new $c_sci_VectorBuilder().init___();
    var i$1 = 0;
  ...
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(jsx$1, center, new $c_Ltetris_types_package$Color().init___I__I__I(255, 0, 0), 0)
});
$c_Ltetris_Piece$.prototype.linePiece__Ltetris_types_package$Point__Ltetris_Piece = (function(center) {
  var this$1 = $m_s_package$().Vector$1;
  var array = [new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I((-1), 1), new $c_Ltetris_types_package$Point().init___I__I((-2), 1)];
  if (($uI(array.length) === 0)) {
    var stdBlocks1 = this$1.NIL$6
  } else {
    var b = new $c_sci_VectorBuilder().init___();
    var i = 0;
    var len = $uI(array.length);
    ...
    var stdBlocks1 = b.result__sci_Vector()
  };
  var this$2 = $m_s_package$().Vector$1;
  var array$1 = [new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(0, (-1))];
  if (($uI(array$1.length) === 0)) {
    var stdBlocks2 = this$2.NIL$6
  } else {
    var b$1 = new $c_sci_VectorBuilder().init___();
    var i$1 = 0;
    var len$1 = $uI(array$1.length);
    ...
    var stdBlocks2 = b$1.result__sci_Vector()
  };
  var this$3 = $m_s_package$().Vector$1;
  var array$2 = [new $c_Ltetris_types_package$Point().init___I__I((-1), 1), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(2, 1)];
  if (($uI(array$2.length) === 0)) {
    var stdBlocks3 = this$3.NIL$6
  } else {
    ...
    var stdBlocks3 = b$2.result__sci_Vector()
  };
  var this$4 = $m_s_package$().Vector$1;
  var array$3 = [new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I(0, 3)];
  if (($uI(array$3.length) === 0)) {
    var stdBlocks4 = this$4.NIL$6
  } else {
    ...
    var stdBlocks4 = b$3.result__sci_Vector()
  };
  var this$5 = $m_s_package$().Vector$1;
  var array$4 = [stdBlocks1, stdBlocks2, stdBlocks3, stdBlocks4];
  if (($uI(array$4.length) === 0)) {
    var jsx$1 = this$5.NIL$6
  } else {
    ...
    var jsx$1 = b$4.result__sci_Vector()
  };
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(jsx$1, center, new $c_Ltetris_types_package$Color().init___I__I__I(0, 255, 0), 0)
});
$c_Ltetris_Piece$.prototype.SPiece__Ltetris_types_package$Point__Ltetris_Piece = (function(center) {
  var this$1 = $m_s_package$().Vector$1;
  var array = [new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 0), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I((-1), 1)];
  if (($uI(array.length) === 0)) {
    var stdBlocks1 = this$1.NIL$6
  ...
  var this$2 = $m_s_package$().Vector$1;
  var array$1 = [new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(1, 2), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 0)];
  if (($uI(array$1.length) === 0)) {
    var stdBlocks2 = this$2.NIL$6
  } else {
    var b$1 = new $c_sci_VectorBuilder().init___();
  ...
  var this$3 = $m_s_package$().Vector$1;
  var array$2 = [new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I((-1), 2), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(1, 1)];
  if (($uI(array$2.length) === 0)) {
    var stdBlocks3 = this$3.NIL$6
  } else {
    var b$2 = new $c_sci_VectorBuilder().init___();
  ...
  var this$4 = $m_s_package$().Vector$1;
  var array$3 = [new $c_Ltetris_types_package$Point().init___I__I((-1), 1), new $c_Ltetris_types_package$Point().init___I__I((-1), 0), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 2)];
  if (($uI(array$3.length) === 0)) {
    var stdBlocks4 = this$4.NIL$6
  } else {
    var b$3 = new $c_sci_VectorBuilder().init___();
  ...
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(jsx$1, center, new $c_Ltetris_types_package$Color().init___I__I__I(255, 255, 0), 0)
});
$c_Ltetris_Piece$.prototype.TPiece__Ltetris_types_package$Point__Ltetris_Piece = (function(center) {
  var this$1 = $m_s_package$().Vector$1;
  var array = [new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 0), new $c_Ltetris_types_package$Point().init___I__I(2, 0), new $c_Ltetris_types_package$Point().init___I__I(1, (-1))];
  if (($uI(array.length) === 0)) {
    var stdBlocks1 = this$1.NIL$6
  } else {
    var b = new $c_sci_VectorBuilder().init___();
  ...
  var this$2 = $m_s_package$().Vector$1;
  var array$1 = [new $c_Ltetris_types_package$Point().init___I__I(1, (-1)), new $c_Ltetris_types_package$Point().init___I__I(1, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(2, 0)];
  if (($uI(array$1.length) === 0)) {
    var stdBlocks2 = this$2.NIL$6
  } else {
    var b$1 = new $c_sci_VectorBuilder().init___();
  ...
  var this$3 = $m_s_package$().Vector$1;
  var array$2 = [new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 0), new $c_Ltetris_types_package$Point().init___I__I(2, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 1)];
  if (($uI(array$2.length) === 0)) {
    var stdBlocks3 = this$3.NIL$6
  } else {
    var b$2 = new $c_sci_VectorBuilder().init___();
  ...
  var this$4 = $m_s_package$().Vector$1;
  var array$3 = [new $c_Ltetris_types_package$Point().init___I__I(1, (-1)), new $c_Ltetris_types_package$Point().init___I__I(1, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 0)];
  if (($uI(array$3.length) === 0)) {
    var stdBlocks4 = this$4.NIL$6
  } else {
    var b$3 = new $c_sci_VectorBuilder().init___();
  ...
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(jsx$1, center, new $c_Ltetris_types_package$Color().init___I__I__I(0, 100, 100), 0)
});
$c_Ltetris_Piece$.prototype.LleftPiece__Ltetris_types_package$Point__Ltetris_Piece = (function(center) {
  var this$1 = $m_s_package$().Vector$1;
  var array = [new $c_Ltetris_types_package$Point().init___I__I(2, 2), new $c_Ltetris_types_package$Point().init___I__I(1, 2), new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I(0, 1)];
  if (($uI(array.length) === 0)) {
    var stdBlocks1 = this$1.NIL$6
  } else {
    var b = new $c_sci_VectorBuilder().init___();
  ...
  var this$2 = $m_s_package$().Vector$1;
  var array$1 = [new $c_Ltetris_types_package$Point().init___I__I(0, 4), new $c_Ltetris_types_package$Point().init___I__I(0, 3), new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I(1, 2)];
  if (($uI(array$1.length) === 0)) {
    var stdBlocks2 = this$2.NIL$6
  } else {
    var b$1 = new $c_sci_VectorBuilder().init___();
  ...
  var this$3 = $m_s_package$().Vector$1;
  var array$2 = [new $c_Ltetris_types_package$Point().init___I__I((-2), 2), new $c_Ltetris_types_package$Point().init___I__I((-1), 2), new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I(0, 3)];
  if (($uI(array$2.length) === 0)) {
    var stdBlocks3 = this$3.NIL$6
  } else {
    var b$2 = new $c_sci_VectorBuilder().init___();
  ...
  var this$4 = $m_s_package$().Vector$1;
  var array$3 = [new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I((-1), 2)];
  if (($uI(array$3.length) === 0)) {
    var stdBlocks4 = this$4.NIL$6
  } else {
    var b$3 = new $c_sci_VectorBuilder().init___();
  ...
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(jsx$1, center, new $c_Ltetris_types_package$Color().init___I__I__I(0, 255, 255), 0)
});
$c_Ltetris_Piece$.prototype.LrightPiece__Ltetris_types_package$Point__Ltetris_Piece = (function(center) {
  var this$1 = $m_s_package$().Vector$1;
  var array = [new $c_Ltetris_types_package$Point().init___I__I((-2), 2), new $c_Ltetris_types_package$Point().init___I__I((-1), 2), new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I(0, 1)];
  if (($uI(array.length) === 0)) {
    var stdBlocks1 = this$1.NIL$6
  ...
  var this$2 = $m_s_package$().Vector$1;
  var array$1 = [new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I(1, 2)];
  if (($uI(array$1.length) === 0)) {
    var stdBlocks2 = this$2.NIL$6
  } else {
    var b$1 = new $c_sci_VectorBuilder().init___();
  ...
  var this$4 = $m_s_package$().Vector$1;
  var array$3 = [new $c_Ltetris_types_package$Point().init___I__I(0, 4), new $c_Ltetris_types_package$Point().init___I__I(0, 3), new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I((-1), 2)];
  if (($uI(array$3.length) === 0)) {
    var stdBlocks4 = this$4.NIL$6
  } else {
    var b$3 = new $c_sci_VectorBuilder().init___();
  ...
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(jsx$1, center, new $c_Ltetris_types_package$Color().init___I__I__I(0, 0, 255), 0)
});
$c_Ltetris_Piece$.prototype.randomPiece__Ltetris_types_package$Point__Ltetris_Piece = (function(center) {
  var this$1 = $m_s_package$().Vector$1;
  var array = [new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(center$2) {
    var center$1 = $as_Ltetris_types_package$Point(center$2);
    return $m_Ltetris_Piece$().squarePiece__Ltetris_types_package$Point__Ltetris_Piece(center$1)
  })), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(center$2$1) {
    var center$3 = $as_Ltetris_types_package$Point(center$2$1);
    return $m_Ltetris_Piece$().linePiece__Ltetris_types_package$Point__Ltetris_Piece(center$3)
  })), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(center$2$2) {
    var center$4 = $as_Ltetris_types_package$Point(center$2$2);
    return $m_Ltetris_Piece$().LleftPiece__Ltetris_types_package$Point__Ltetris_Piece(center$4)
  })), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(center$2$3) {
    var center$5 = $as_Ltetris_types_package$Point(center$2$3);
    return $m_Ltetris_Piece$().LrightPiece__Ltetris_types_package$Point__Ltetris_Piece(center$5)
  })), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(center$2$4) {
    var center$6 = $as_Ltetris_types_package$Point(center$2$4);
    return $m_Ltetris_Piece$().SPiece__Ltetris_types_package$Point__Ltetris_Piece(center$6)
  })), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(center$2$5) {
    var center$7 = $as_Ltetris_types_package$Point(center$2$5);
    return $m_Ltetris_Piece$().ZPiece__Ltetris_types_package$Point__Ltetris_Piece(center$7)
  })), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(center$2$6) {
    var center$8 = $as_Ltetris_types_package$Point(center$2$6);
    return $m_Ltetris_Piece$().TPiece__Ltetris_types_package$Point__Ltetris_Piece(center$8)
  }))];
  if (($uI(array.length) === 0)) {
    var pieces = this$1.NIL$6
  } else {
    var b = new $c_sci_VectorBuilder().init___();
    var i = 0;
    var len = $uI(array.length);
    ...
    var pieces = b.result__sci_Vector()
  };
  var this$2 = $m_s_util_Random$();
  var n = pieces.length__I();
  return $as_Ltetris_Piece($as_F1(pieces.apply__I__O(this$2.self$1.nextInt__I__I(n))).apply__O__O(center))
});
$c_Ltetris_Piece$.prototype.ZPiece__Ltetris_types_package$Point__Ltetris_Piece = (function(center) {
  var this$1 = $m_s_package$().Vector$1;
  var array = [new $c_Ltetris_types_package$Point().init___I__I(0, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 0), new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(2, 1)];
  if (($uI(array.length) === 0)) {
    var stdBlocks1 = this$1.NIL$6
  } else {
    var b = new $c_sci_VectorBuilder().init___();
  ...
  var this$2 = $m_s_package$().Vector$1;
  var array$1 = [new $c_Ltetris_types_package$Point().init___I__I(2, 0), new $c_Ltetris_types_package$Point().init___I__I(2, 1), new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(1, 2)];
  if (($uI(array$1.length) === 0)) {
    var stdBlocks2 = this$2.NIL$6
  } else {
    var b$1 = new $c_sci_VectorBuilder().init___();
  ...
  var this$3 = $m_s_package$().Vector$1;
  var array$2 = [new $c_Ltetris_types_package$Point().init___I__I(2, 2), new $c_Ltetris_types_package$Point().init___I__I(1, 2), new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(0, 1)];
  if (($uI(array$2.length) === 0)) {
    var stdBlocks3 = this$3.NIL$6
  } else {
    var b$2 = new $c_sci_VectorBuilder().init___();
  ...
  var this$4 = $m_s_package$().Vector$1;
  var array$3 = [new $c_Ltetris_types_package$Point().init___I__I(0, 2), new $c_Ltetris_types_package$Point().init___I__I(0, 1), new $c_Ltetris_types_package$Point().init___I__I(1, 1), new $c_Ltetris_types_package$Point().init___I__I(1, 0)];
  if (($uI(array$3.length) === 0)) {
    var stdBlocks4 = this$4.NIL$6
  } else {
    var b$3 = new $c_sci_VectorBuilder().init___();
  ...
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(jsx$1, center, new $c_Ltetris_types_package$Color().init___I__I__I(255, 0, 255), 0)
});
var $d_Ltetris_Piece$ = new $TypeData().initClass({
  Ltetris_Piece$: 0
}, false, "tetris.Piece$", {
  Ltetris_Piece$: 1,
  O: 1,
...
$c_Ltetris_Piece$.prototype.$classData = $d_Ltetris_Piece$;
var $n_Ltetris_Piece$ = (void 0);
function $m_Ltetris_Piece$() {
  if ((!$n_Ltetris_Piece$)) {
    $n_Ltetris_Piece$ = new $c_Ltetris_Piece$().init___()
  };
  return $n_Ltetris_Piece$
}
...
function $c_Ltetris_GameState() {
  $c_O.call(this);
  this.grid$1 = null;
  this.activePiece$1 = null;
  this.lines$1 = 0;
  this.gameEnded$1 = false;
  this.nextPiece$1 = null
}
$c_Ltetris_GameState.prototype = new $h_O();
$c_Ltetris_GameState.prototype.constructor = $c_Ltetris_GameState;
/** @constructor */
...
$h_Ltetris_GameState.prototype = $c_Ltetris_GameState.prototype;
$c_Ltetris_GameState.prototype.moveDown__Ltetris_GameState = (function() {
  if (this.gameEnded$1) {
    return this
  } else {
    var shiftedPiece = this.activePiece$1.move__I__I__Ltetris_Piece(0, 1);
    if ((this.intersectsGrid__Ltetris_Piece__Z(shiftedPiece) || this.pieceHitsFloor__Ltetris_Piece__Z(shiftedPiece))) {
      var nextGrid = this.updatedGrid__sci_Vector__Ltetris_types_package$Color__sci_Vector(this.activePiece$1.blocks__sci_Vector(), this.activePiece$1.color$1);
      var gs = new $c_Ltetris_GameState().init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece(nextGrid, this.nextPiece$1, this.lines$1, this.gameEnded$1, this.randomActivePiece__Ltetris_Piece()).eliminateLines__Ltetris_GameState();
      return (gs.intersectsGrid__Ltetris_Piece__Z(this.randomActivePiece__Ltetris_Piece()) ? new $c_Ltetris_GameState().init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece(gs.grid$1, gs.activePiece$1, gs.lines$1, true, gs.nextPiece$1) : gs)
    } else {
      return new $c_Ltetris_GameState().init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece(this.grid$1, shiftedPiece, this.lines$1, this.gameEnded$1, this.nextPiece$1)
    }
  }
});
$c_Ltetris_GameState.prototype.insideGrid__Ltetris_types_package$Point__Z = (function(point) {
  var x = point.x$1;
  var y = point.y$1;
  return ((((y >= 0) && (y < this.grid$1.length__I())) && (x >= 0)) && (x < this.width__I()))
});
$c_Ltetris_GameState.prototype.pieceHitsFloor__Ltetris_Piece__Z = (function(piece) {
  var this$1 = piece.blocks__sci_Vector();
  var this$2 = this$1.iterator__sci_VectorIterator();
  var res = false;
  while (((!res) && this$2.$$undhasNext$2)) {
    var arg1 = this$2.next__O();
    var x0$4 = $as_Ltetris_types_package$Point(arg1);
    if ((x0$4 === null)) {
      throw new $c_s_MatchError().init___O(x0$4)
    };
    var x = x0$4.x$1;
    var y = x0$4.y$1;
    if ((y >= this.grid$1.length__I())) {
      res = true
    } else if (this.insideGrid__Ltetris_types_package$Point__Z(new $c_Ltetris_types_package$Point().init___I__I(x, y))) {
      var x$2 = $as_sci_Vector(this.grid$1.apply__I__O(y)).apply__I__O(x);
      var x$3 = new $c_Ltetris_types_package$Color().init___I__I__I(0, 0, 0);
      res = (!((x$2 !== null) && $objectEquals(x$2, x$3)))
    } else {
      res = false
    }
  };
...
$c_Ltetris_GameState.prototype.productPrefix__T = (function() {
  return "GameState"
});
$c_Ltetris_GameState.prototype.productArity__I = (function() {
  return 5
});
$c_Ltetris_GameState.prototype.eliminateLines__Ltetris_GameState = (function() {
  var this$2 = this.grid$1;
  $m_sci_Vector$();
  var bf = $m_sc_IndexedSeq$().ReusableCBF$6;
  var x1 = $as_sc_IterableLike($s_sc_IterableLike$class__zipWithIndex__sc_IterableLike__scg_CanBuildFrom__O(this$2, bf)).find__F1__s_Option(new $c_Ltetris_GameState$$anonfun$1().init___Ltetris_GameState(this));
  if ($is_s_Some(x1)) {
    var x2 = $as_s_Some(x1);
    var p3 = $as_T2(x2.x$2);
    if ((p3 !== null)) {
      var i = $uI(p3.$$und2$f);
      var rowDeleted = $as_sci_Vector(this.grid$1.slice__I__I__sci_Vector(0, i).$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(this.grid$1.slice__I__I__sci_Vector(((1 + i) | 0), ((1 + this.grid$1.length__I()) | 0)), ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
      $m_s_package$();
      var n = this.width__I();
      var b = new $c_sci_VectorBuilder().init___();
      var i$1 = 0;
      ...
      var x$2 = b.result__sci_Vector();
      var newGrid = $as_sci_Vector(rowDeleted.$$plus$colon__O__scg_CanBuildFrom__O(x$2, ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
      return new $c_Ltetris_GameState().init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece(newGrid, this.activePiece$1, ((1 + this.lines$1) | 0), this.gameEnded$1, this.nextPiece$1).eliminateLines__Ltetris_GameState()
    }
  };
  var x = $m_s_None$();
  if ((x === x1)) {
...
$c_Ltetris_GameState.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ltetris_GameState(x$1)) {
    var GameState$1 = $as_Ltetris_GameState(x$1);
    var x = this.grid$1;
    var x$2 = GameState$1.grid$1;
    if (((x === null) ? (x$2 === null) : $s_sc_GenSeqLike$class__equals__sc_GenSeqLike__O__Z(x, x$2))) {
      var x$3 = this.activePiece$1;
      var x$4 = GameState$1.activePiece$1;
      var jsx$1 = ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
    } else {
      var jsx$1 = false
    };
    if (((jsx$1 && (this.lines$1 === GameState$1.lines$1)) && (this.gameEnded$1 === GameState$1.gameEnded$1))) {
      var x$5 = this.nextPiece$1;
      var x$6 = GameState$1.nextPiece$1;
...
$c_Ltetris_GameState.prototype.width__I = (function() {
  return $as_sci_Vector(this.grid$1.apply__I__O(0)).length__I()
});
$c_Ltetris_GameState.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.grid$1;
      break
    ...
    case 3: {
      return this.gameEnded$1;
      break
    }
    case 4: {
      return this.nextPiece$1;
      break
    }
    default: {
...
$c_Ltetris_GameState.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ltetris_GameState.prototype.randomActivePiece__Ltetris_Piece = (function() {
  return $m_Ltetris_Piece$().randomPiece__Ltetris_types_package$Point__Ltetris_Piece(new $c_Ltetris_types_package$Point().init___I__I((((-1) + ((this.width__I() / 2) | 0)) | 0), 0))
});
$c_Ltetris_GameState.prototype.updatedGrid__sci_Vector__Ltetris_types_package$Color__sci_Vector = (function(points, color) {
  var z = this.grid$1;
  var this$1 = points.iterator__sci_VectorIterator();
  var this$2 = $s_sc_TraversableOnce$class__reversed__sc_TraversableOnce__sci_List(this$1);
  var acc = z;
  var these = this$2;
  while ((!these.isEmpty__Z())) {
    var arg1 = acc;
    var arg2 = these.head__O();
    var x0$2 = $as_Ltetris_types_package$Point(arg2);
    var x1$1 = $as_sci_Vector(arg1);
    var x1 = new $c_T2().init___O__O(x0$2, x1$1);
    matchEnd4: {
      var p2 = $as_Ltetris_types_package$Point(x1.$$und1$f);
      var g = $as_sci_Vector(x1.$$und2$f);
      if ((p2 !== null)) {
        var x = p2.x$1;
        var y = p2.y$1;
        if (this.insideGrid__Ltetris_types_package$Point__Z(new $c_Ltetris_types_package$Point().init___I__I(x, y))) {
          var row = $as_sci_Vector($as_sci_Vector(g.apply__I__O(y)).updated__I__O__scg_CanBuildFrom__O(x, color, ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
          acc = $as_sci_Vector(g.updated__I__O__scg_CanBuildFrom__O(y, row, ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
          break matchEnd4
        } else {
          acc = g;
          break matchEnd4
  ...
  return $as_sci_Vector(acc)
});
$c_Ltetris_GameState.prototype.intersectsGrid__Ltetris_Piece__Z = (function(piece) {
  var this$1 = piece.blocks__sci_Vector();
  var this$2 = this$1.iterator__sci_VectorIterator();
  var res = false;
  while (((!res) && this$2.$$undhasNext$2)) {
    var arg1 = this$2.next__O();
    var x0$1 = $as_Ltetris_types_package$Point(arg1);
    if ((x0$1 === null)) {
...
$c_Ltetris_GameState.prototype.init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece = (function(grid, activePiece, lines, gameEnded, nextPiece) {
  this.grid$1 = grid;
  this.activePiece$1 = activePiece;
  this.lines$1 = lines;
  this.gameEnded$1 = gameEnded;
  this.nextPiece$1 = nextPiece;
  return this
});
$c_Ltetris_GameState.prototype.moveRight__Ltetris_GameState = (function() {
  var movedPiece = this.activePiece$1.move__I__I__Ltetris_Piece(1, 0);
  return ((this.insideGrid__Ltetris_Piece__Z(movedPiece) && (!this.intersectsGrid__Ltetris_Piece__Z(movedPiece))) ? new $c_Ltetris_GameState().init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece(this.grid$1, movedPiece, this.lines$1, this.gameEnded$1, this.nextPiece$1) : this)
});
$c_Ltetris_GameState.prototype.insideGrid__Ltetris_Piece__Z = (function(piece) {
  var this$1 = piece.blocks__sci_Vector();
  var this$2 = this$1.iterator__sci_VectorIterator();
  var res = true;
  while ((res && this$2.$$undhasNext$2)) {
    var arg1 = this$2.next__O();
    var pt = $as_Ltetris_types_package$Point(arg1);
    res = this.insideGrid__Ltetris_types_package$Point__Z(pt)
  };
  return res
});
$c_Ltetris_GameState.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.grid$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.activePiece$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.lines$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, (this.gameEnded$1 ? 1231 : 1237));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.nextPiece$1));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 5)
});
$c_Ltetris_GameState.prototype.rotate__Ltetris_GameState = (function() {
  var rotatedPiece = this.activePiece$1.rotate__Ltetris_Piece();
  return ((this.insideGrid__Ltetris_Piece__Z(rotatedPiece) && (!this.intersectsGrid__Ltetris_Piece__Z(rotatedPiece))) ? new $c_Ltetris_GameState().init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece(this.grid$1, rotatedPiece, this.lines$1, this.gameEnded$1, this.nextPiece$1) : this)
});
$c_Ltetris_GameState.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Ltetris_GameState.prototype.moveLeft__Ltetris_GameState = (function() {
  var movedPiece = this.activePiece$1.move__I__I__Ltetris_Piece((-1), 0);
  return ((this.insideGrid__Ltetris_Piece__Z(movedPiece) && (!this.intersectsGrid__Ltetris_Piece__Z(movedPiece))) ? new $c_Ltetris_GameState().init___sci_Vector__Ltetris_Piece__I__Z__Ltetris_Piece(this.grid$1, movedPiece, this.lines$1, this.gameEnded$1, this.nextPiece$1) : this)
});
function $is_Ltetris_GameState(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ltetris_GameState)))
}
function $as_Ltetris_GameState(obj) {
  return (($is_Ltetris_GameState(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "tetris.GameState"))
}
function $isArrayOf_Ltetris_GameState(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltetris_GameState)))
}
function $asArrayOf_Ltetris_GameState(obj, depth) {
  return (($isArrayOf_Ltetris_GameState(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltetris.GameState;", depth))
}
var $d_Ltetris_GameState = new $TypeData().initClass({
  Ltetris_GameState: 0
}, false, "tetris.GameState", {
...
$c_Ltetris_GameState.prototype.$classData = $d_Ltetris_GameState;
/** @constructor */
function $c_Ltetris_GameState$$anonfun$1() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Ltetris_GameState$$anonfun$1.prototype = new $h_sr_AbstractFunction1();
$c_Ltetris_GameState$$anonfun$1.prototype.constructor = $c_Ltetris_GameState$$anonfun$1;
/** @constructor */
function $h_Ltetris_GameState$$anonfun$1() {
  /*<skip>*/
}
$h_Ltetris_GameState$$anonfun$1.prototype = $c_Ltetris_GameState$$anonfun$1.prototype;
$c_Ltetris_GameState$$anonfun$1.prototype.apply__O__O = (function(v1) {
  return this.apply__T2__Z($as_T2(v1))
});
$c_Ltetris_GameState$$anonfun$1.prototype.apply__T2__Z = (function(x0$3) {
  if ((x0$3 !== null)) {
    var row = $as_sci_Vector(x0$3.$$und1$f);
    var this$1 = row.iterator__sci_VectorIterator();
    var res = true;
    while ((res && this$1.$$undhasNext$2)) {
      var arg1 = this$1.next__O();
      var x$1 = $as_Ltetris_types_package$Color(arg1);
      var x$2 = new $c_Ltetris_types_package$Color().init___I__I__I(0, 0, 0);
      res = (!((x$1 !== null) && x$1.equals__O__Z(x$2)))
    };
    return res
  } else {
...
$c_Ltetris_GameState$$anonfun$1.prototype.init___Ltetris_GameState = (function($$outer) {
  return this
});
var $d_Ltetris_GameState$$anonfun$1 = new $TypeData().initClass({
  Ltetris_GameState$$anonfun$1: 0
}, false, "tetris.GameState$$anonfun$1", {
  Ltetris_GameState$$anonfun$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Ltetris_GameState$$anonfun$1.prototype.$classData = $d_Ltetris_GameState$$anonfun$1;
/** @constructor */
function $c_Ltetris_Piece() {
  $c_O.call(this);
  this.orientedBlocks$1 = null;
  this.center$1 = null;
  this.color$1 = null;
...
$h_Ltetris_Piece.prototype = $c_Ltetris_Piece.prototype;
$c_Ltetris_Piece.prototype.move__I__I__Ltetris_Piece = (function(right, down) {
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(this.orientedBlocks$1, this.center$1.$$plus__Ltetris_types_package$Point__Ltetris_types_package$Point(new $c_Ltetris_types_package$Point().init___I__I(right, down)), this.color$1, this.orientation$1)
});
$c_Ltetris_Piece.prototype.productPrefix__T = (function() {
  return "Piece"
});
$c_Ltetris_Piece.prototype.productArity__I = (function() {
  return 4
});
$c_Ltetris_Piece.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ltetris_Piece(x$1)) {
    var Piece$1 = $as_Ltetris_Piece(x$1);
    var x = this.orientedBlocks$1;
    var x$2 = Piece$1.orientedBlocks$1;
    if (((x === null) ? (x$2 === null) : $s_sc_GenSeqLike$class__equals__sc_GenSeqLike__O__Z(x, x$2))) {
      var x$3 = this.center$1;
      var x$4 = Piece$1.center$1;
    ...
    if (jsx$2) {
      ...
      var x$6 = Piece$1.color$1;
      var jsx$1 = ((x$5 === null) ? (x$6 === null) : x$5.equals__O__Z(x$6))
    } else {
      var jsx$1 = false
    };
    if (jsx$1) {
      return (this.orientation$1 === Piece$1.orientation$1)
    } else {
      return false
    }
  } else {
...
$c_Ltetris_Piece.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.orientedBlocks$1;
      break
    }
    case 1: {
...
$c_Ltetris_Piece.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ltetris_Piece.prototype.rotate__Ltetris_Piece = (function() {
  return new $c_Ltetris_Piece().init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I(this.orientedBlocks$1, this.center$1, this.color$1, ((((1 + this.orientation$1) | 0) % 4) | 0))
});
$c_Ltetris_Piece.prototype.init___sci_Vector__Ltetris_types_package$Point__Ltetris_types_package$Color__I = (function(orientedBlocks, center, color, orientation) {
  this.orientedBlocks$1 = orientedBlocks;
  this.center$1 = center;
  this.color$1 = color;
  this.orientation$1 = orientation;
  return this
});
$c_Ltetris_Piece.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.orientedBlocks$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.center$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.color$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.orientation$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 4)
});
$c_Ltetris_Piece.prototype.blocks__sci_Vector = (function() {
  return $as_sci_Vector($as_sc_TraversableLike(this.orientedBlocks$1.apply__I__O(this.orientation$1)).map__F1__scg_CanBuildFrom__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(x$1$2) {
      var x$1 = $as_Ltetris_types_package$Point(x$1$2);
      return x$1.$$plus__Ltetris_types_package$Point__Ltetris_types_package$Point(arg$outer.center$1)
    })
  })(this)), ($m_sci_Vector$(), $m_sc_IndexedSeq$().ReusableCBF$6)))
});
$c_Ltetris_Piece.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Ltetris_Piece(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ltetris_Piece)))
}
function $as_Ltetris_Piece(obj) {
  return (($is_Ltetris_Piece(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "tetris.Piece"))
}
function $isArrayOf_Ltetris_Piece(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltetris_Piece)))
}
function $asArrayOf_Ltetris_Piece(obj, depth) {
  return (($isArrayOf_Ltetris_Piece(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltetris.Piece;", depth))
}
var $d_Ltetris_Piece = new $TypeData().initClass({
  Ltetris_Piece: 0
}, false, "tetris.Piece", {
...
$c_Ltetris_Piece.prototype.$classData = $d_Ltetris_Piece;
/** @constructor */
function $c_Ltetris_types_package$Color() {
  $c_O.call(this);
  this.r$1 = 0;
  this.g$1 = 0;
  this.b$1 = 0
}
$c_Ltetris_types_package$Color.prototype = new $h_O();
$c_Ltetris_types_package$Color.prototype.constructor = $c_Ltetris_types_package$Color;
/** @constructor */
function $h_Ltetris_types_package$Color() {
  /*<skip>*/
}
$h_Ltetris_types_package$Color.prototype = $c_Ltetris_types_package$Color.prototype;
$c_Ltetris_types_package$Color.prototype.productPrefix__T = (function() {
  return "Color"
});
$c_Ltetris_types_package$Color.prototype.productArity__I = (function() {
  return 3
});
$c_Ltetris_types_package$Color.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ltetris_types_package$Color(x$1)) {
    var Color$1 = $as_Ltetris_types_package$Color(x$1);
    return (((this.r$1 === Color$1.r$1) && (this.g$1 === Color$1.g$1)) && (this.b$1 === Color$1.b$1))
  } else {
    return false
  }
});
$c_Ltetris_types_package$Color.prototype.init___I__I__I = (function(r, g, b) {
  this.r$1 = r;
  this.g$1 = g;
  this.b$1 = b;
  return this
});
$c_Ltetris_types_package$Color.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.r$1;
      break
...
$c_Ltetris_types_package$Color.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ltetris_types_package$Color.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Ltetris_types_package$Color.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Ltetris_types_package$Color(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ltetris_types_package$Color)))
}
function $as_Ltetris_types_package$Color(obj) {
  return (($is_Ltetris_types_package$Color(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "tetris.types.package$Color"))
}
function $isArrayOf_Ltetris_types_package$Color(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltetris_types_package$Color)))
}
function $asArrayOf_Ltetris_types_package$Color(obj, depth) {
  return (($isArrayOf_Ltetris_types_package$Color(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltetris.types.package$Color;", depth))
}
var $d_Ltetris_types_package$Color = new $TypeData().initClass({
  Ltetris_types_package$Color: 0
}, false, "tetris.types.package$Color", {
  Ltetris_types_package$Color: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Ltetris_types_package$Color.prototype.$classData = $d_Ltetris_types_package$Color;
/** @constructor */
function $c_Ltetris_types_package$Point() {
  $c_O.call(this);
  this.x$1 = 0;
  this.y$1 = 0
}
$c_Ltetris_types_package$Point.prototype = new $h_O();
$c_Ltetris_types_package$Point.prototype.constructor = $c_Ltetris_types_package$Point;
/** @constructor */
function $h_Ltetris_types_package$Point() {
  /*<skip>*/
}
$h_Ltetris_types_package$Point.prototype = $c_Ltetris_types_package$Point.prototype;
$c_Ltetris_types_package$Point.prototype.productPrefix__T = (function() {
  return "Point"
});
$c_Ltetris_types_package$Point.prototype.productArity__I = (function() {
  return 2
});
$c_Ltetris_types_package$Point.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Ltetris_types_package$Point(x$1)) {
    var Point$1 = $as_Ltetris_types_package$Point(x$1);
    return ((this.x$1 === Point$1.x$1) && (this.y$1 === Point$1.y$1))
  } else {
    return false
  }
});
$c_Ltetris_types_package$Point.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.x$1;
      break
...
$c_Ltetris_types_package$Point.prototype.init___I__I = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
$c_Ltetris_types_package$Point.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Ltetris_types_package$Point.prototype.$$plus__Ltetris_types_package$Point__Ltetris_types_package$Point = (function(p) {
  return new $c_Ltetris_types_package$Point().init___I__I(((this.x$1 + p.x$1) | 0), ((this.y$1 + p.y$1) | 0))
});
$c_Ltetris_types_package$Point.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Ltetris_types_package$Point.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Ltetris_types_package$Point(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ltetris_types_package$Point)))
}
function $as_Ltetris_types_package$Point(obj) {
  return (($is_Ltetris_types_package$Point(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "tetris.types.package$Point"))
}
function $isArrayOf_Ltetris_types_package$Point(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltetris_types_package$Point)))
}
function $asArrayOf_Ltetris_types_package$Point(obj, depth) {
  return (($isArrayOf_Ltetris_types_package$Point(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltetris.types.package$Point;", depth))
}
var $d_Ltetris_types_package$Point = new $TypeData().initClass({
  Ltetris_types_package$Point: 0
}, false, "tetris.types.package$Point", {
  Ltetris_types_package$Point: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Ltetris_types_package$Point.prototype.$classData = $d_Ltetris_types_package$Point;
/** @constructor */
...
$c_sci_Vector.prototype.slice__I__I__sci_Vector = (function(from, until) {
  return this.take__I__sci_Vector(until).drop__I__sci_Vector(from)
});
...
//# sourceMappingURL=scala-js-tetris-fastopt.js.map
